      ...
      <div className="wrap">
        ...
        <section className="panel" aria-label="Based generator">
          <div className="stage" id="stage" aria-live="polite">
            <div className="congratsText" id="congratsText">Congratulations</div>
            ...
            <div className="meta">
              <a className="handleLink" id="handleLink" href="#" target="_blank" rel="noreferrer">@…</a>
              <div className="bio" id="bio">Tap the button below.</div>
          ...
          <div className="actions">
            <div className="btns">
              <button className="primary" id="btn">Based me</button>
